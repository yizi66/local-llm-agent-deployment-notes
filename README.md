...
**本项目**：记录了在 RTX 5060 Laptop (8GB) + i9-14900HX 笔记本上，全程使用国内镜像站和代理工具，最终实现本地模型通过 Python Agent 调用外部工具的过程。所有失败与解决方案均被保留，供后来者参考。
...
- **解决方案**：引入 [LiteLLM](https://github.com/BerriAI/litellm) 代理，将 Ollama 包装为完全兼容的 OpenAI API
...
| 模型服务 | [Ollama](https://ollama.com/) | 本地模型管理 & API 服务 |
| 代理 | [LiteLLM](https://github.com/BerriAI/litellm) | OpenAI 协议转换 |
